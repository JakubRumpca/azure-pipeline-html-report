            ...
            {(props: { selectedTabId: string }) => {
              if ( this.tabContents.get(props.selectedTabId) === this.tabInitialContent) {
                this.props.attachmentClient.getAttachmentContent(props.selectedTabId).then((content) => {
                  this.tabContents.set(props.selectedTabId, '<div><div class="wide flex-row flex-center" srcdoc="' + this.escapeHTML(" ") + '" ></div><iframe class="wide flex-row flex-center" srcdoc="' + this.escapeHTML(content) + '"></iframe></div>')
              })
            }
